...
chmod +x ~/windsurf-memory/auto_summary_agent.py

# 백업 시 자동 호출 추가 (optional)
echo 'python3 ~/windsurf-memory/auto_summary_agent.py' >> ~/windsurf-memory/auto_backup_monitor.py

echo "✅ Lv4.5 자동 요약 시스템 설치 완료!"

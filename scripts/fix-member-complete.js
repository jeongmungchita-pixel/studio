...
/**
 * Fix all Firebase Admin SDK method calls in member.ts
 */

const fs = require('fs');
const path = require('path');

const filePath = path.join(__dirname, '../src/adapters/firebase/member.ts');

console.log('🔧 member.ts 전체 Firebase Admin SDK 수정...');

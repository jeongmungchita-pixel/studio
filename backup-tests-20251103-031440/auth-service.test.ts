...
describe('AuthService', () => {
  ...
  describe('getRedirectUrl', () => {
    it('should return correct URLs for different roles', () => {
      const testCases = [
        { role: UserRole.SUPER_ADMIN, expected: '/admin/dashboard' },
        { role: UserRole.FEDERATION_ADMIN, expected: '/admin/dashboard' },
        { role: UserRole.CLUB_OWNER, expected: '/club-dashboard' },
        { role: UserRole.CLUB_MANAGER, expected: '/club-dashboard' },
        { role: UserRole.HEAD_COACH, expected: '/coach-dashboard' },
        { role: UserRole.ASSISTANT_COACH, expected: '/coach-dashboard' },
        { role: UserRole.COMMITTEE_CHAIR, expected: '/dashboard' },
        { role: UserRole.COMMITTEE_MEMBER, expected: '/dashboard' },
        { role: UserRole.MEMBER, expected: '/dashboard' },
        { role: UserRole.PARENT, expected: '/dashboard' },
      ];

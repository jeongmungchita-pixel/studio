...
describe('UserService - DI Pattern Test Suite', () => {
  ...
  describe('DI Pattern', () => {
    it('should create service with DI', () => {
      expect(userService).toBeInstanceOf(UserService);
    });

    it('should use injected API client', () => {
  ...
  describe('User CRUD Operations', () => {
    describe('getUsers', () => {
      it('should fetch paginated users', async () => {
        ...
        vi.mocked(mockgetPaginated).mockResolvedValue(mockResponse);
    ...
    describe('getUser', () => {
      it('should fetch a single user', async () => {
        vi.mocked(mockget).mockResolvedValue(mockUser);
    ...
    describe('createUser', () => {
      it('should create a new user', async () => {
        ...
        vi.mocked(mockpost).mockResolvedValue({
          ...mockUser,
          ...createData
        });
    ...
    describe('updateUser', () => {
      it('should update user data', async () => {
        ...
        vi.mocked(mockPut).mockResolvedValue({
          success: true,
          data: {
            ...mockUser,
            ...updateData
    ...
    describe('deleteUser', () => {
      it('should delete a user', async () => {
        vi.mocked(mockDelete).mockResolvedValue({ id: 'user-123' });
  ...
  describe('Profile Operations', () => {
    ...
    describe('uploadProfileImage', () => {
      it('should upload profile image', async () => {
        ...
        vi.mocked(mockupload).mockResolvedValue({ url: mockUrl });
  ...
  describe('Query Operations', () => {
    describe('getUsersByRole', () => {
      it('should fetch users by role', async () => {
        ...
        vi.mocked(mockgetPaginated).mockResolvedValue({
          items: mockUsers,
          total: 2,
          page: 1,
          pageSize: 100,
    ...
    describe('searchUsers', () => {
      it('should search users', async () => {
        ...
        vi.mocked(mockget).mockResolvedValue(searchResults);
  ...
  describe('Status and Role Management', () => {
    describe('changeUserStatus', () => {
      it('should change user status', async () => {
        ...
        vi.mocked(mockPut).mockResolvedValue(updatedUser);
    ...
    describe('activateUser', () => {
      it('should activate user', async () => {
        ...
        vi.mocked(mockput).mockResolvedValue(activatedUser);
    ...
    describe('deactivateUser', () => {
      it('should deactivate user', async () => {
        ...
        vi.mocked(mockput).mockResolvedValue(deactivatedUser);
  ...
  describe('Bulk Operations', () => {
    describe('createBulkUsers', () => {
      it('should create multiple users', async () => {
        ...
        vi.mocked(mockpost).mockResolvedValue(createdUsers);
    ...
    describe('exportUsers', () => {
      it('should export users to CSV', async () => {
        vi.mocked(mockdownload).mockResolvedValue(undefined);
  ...
  describe('Statistics', () => {
    describe('getUserStats', () => {
      it('should fetch user statistics', async () => {
        ...
        vi.mocked(mockget).mockResolvedValue(mockStats);

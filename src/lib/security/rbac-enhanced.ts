...
export enum Permission {
  // 사용자 관리
  USER_READ = '_user:read',
  USER_CREATE = '_user:create',
  USER_UPDATE = '_user:update',
  USER_DELETE = '_user:delete',
  USER_UPDATE_ROLE = '_user:update_role',
  USER_UPDATE_STATUS = '_user:update_status',
  // 클럽 관리
  CLUB_READ = 'club:read',
  ...
  // 이벤트 관리
  EVENT_READ = '_event:read',
  EVENT_CREATE = '_event:create',
  EVENT_UPDATE = '_event:update',
  EVENT_DELETE = '_event:delete',
  EVENT_MANAGE_PARTICIPANTS = '_event:manage_participants',
  // 재정 관리

...
export default function ProfileSetupPage() {
  ...
  const onSubmit = async (values: FormValues) => {
    ...
    try {
      ...
      const guardianUids: string[] = [user.uid]; // Start with the current user as a guardian
      ...
      if (values.adultsInfo && values.adultsInfo.length > 0) {
        for (let i = 0; i < values.adultsInfo.length; i++) {
          ...
          const memberPayload: Member = {
            ...
            gender: adult.gender,
            email: user.email, // Use guardian's email for adult members as well
            phoneNumber: values.phoneNumber,
                ...
                {adultFields.map((field, index) => (
                  ...
                  >
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-4 items-start">
                      ...
                      />
                      <div className="flex items-center gap-4 pt-0 sm:pt-8">

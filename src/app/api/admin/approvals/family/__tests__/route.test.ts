...
describe('/api/admin/approvals/family route', () => {
  beforeEach(() => {
    vi.resetModules();
    vi.clearAllMocks();
  });

  it('approves family registration for admin/staff', async () => {
    const tx = {
      ...
      get: vi.fn()
        .mockResolvedValueOnce({ exists: true, data: () => ({
          ...
          clubId: 'club1',
          clubName: 'Club One',
          parents: [{ name: 'Parent', birthDate: '1980-01-01', gender: 'male', phoneNumber: '010', email: 'p@p.com' }],
          children: [{ name: 'Child', birthDate: '2015-01-01', gender: 'female' }],
          requestedBy: 'u1',
        }) })
